...
**Snake Web** 是一款完全基于现代 Web 技术开发的贪吃蛇游戏，作为 **Web_Game_01** 系列的首款作品，它不仅是对经典游戏的致敬，更是一次前端工程化实践的深度探索。
...
- [01-项目立项](docs/01-项目立项.md) - 项目背景、目标、范围
- [02-需求拆分](docs/02-需求拆分.md) - 功能需求、非功能需求
- [03-技术选型](docs/03-技术选型.md) - 技术栈选择、理由
- [04-项目架构](docs/04-项目架构.md) - 架构设计、模块职责
- [05-执行规划](docs/05-执行规划.md) - 开发计划、里程碑
- [06-部署指南](docs/06-部署指南.md) - 部署流程、配置说明
